    ...
    $(function() {
        ...
        $('.connected-sortable').sortable({
            ...
            update: function(event, ui) {
                ...
                $container.find('[name^="cfgroup[fields]"]').each(function() {
        ...
        $(document).on('click', '.cfgroup_add_field', function() {
            ...
            $('.fields').append('<li class="sortable-item">' + html + '</li>');
        ...
        $(document).on('change', '.field_form .field_type select', function() {
            ...
            //     newRepeater.append('<div class="connected-sortable-wrapper"><ul class="connected-sortable sortable-item"></ul></div>');
            //     $('.connected-sortable').sortable({
            //         items: '.sortable-item',
            //         connectWith: '.connected-sortable',
            //         placeholder: 'ui-sortable-placeholder',
        ...
        $(document).on('change', '.field_form .field_option_file select', function() {
            var file_type = $(this).val();
            if ( file_type == 'file' ) {
                file_type = 'any';
            }
            $(this).parents('.field').find('.field_meta .field_type').text('');
            $(this).parents('.field').find('.field_meta .field_type').append('file ('+file_type+')');
        });
